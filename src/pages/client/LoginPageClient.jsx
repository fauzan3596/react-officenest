...
const LoginPageClient = () => {
  ...
  return (
    <div className="flex md:flex-row flex-col items-center min-h-screen w-full md:py-5 md:px-10 p-0">
      <div className="flex flex-col md:w-[60%] md:h-[33rem] w-full items-center py-5 px-10 relative">
        ...
        <div className="divider md:px-14">Or Login With</div>
        <div className="md:px-14 w-full">
          <button
            className="btn text-lg btn-outline border-gray-200 border-2 font-semibold w-full"
      ...
      >
        <p className="text-5xl lg:text-5xl md:text-4xl font-bold pb-5 text-left">
          Welcome to OfficeNest
        </p>
        <h2 className="text-lg md:text-base lg:text-lg text-left font-medium">
          Log in now to access a world of premium tools and supplies designed to
          simplify your tasks and elevate your workday experience!
        </h2>
